...
import (
	routes "cleanarchitecture-example/app/routes/api"
...
func UserSetupRoute(fiberConApp *fiber.App, dbConfig *databases.DatabaseConfig, authStoreInstance *utils.RedisAuthStore, middleware *middlewares.RedisAuthMiddleware) *UserSetup {
